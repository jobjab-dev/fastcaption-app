...
export const config = {
  matcher: [
     ...
     */
    "/((?!_next/static|_next/image|favicon.ico|auth/callback|api/auth/callback|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$|api/webhooks|api/stripe/webhook|api/omise/webhook|api/crypto/webhook|api/v1/).*)",
  ],
};
