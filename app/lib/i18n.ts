...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "login.emailSubmit": "✉️ Send Magic Link",
    "login.emailSent": "Magic link sent!",
    "login.emailSentDesc": "Check your inbox — click the link we sent to sign in. You can close this tab.",
    "login.phonePlaceholder": "+66 812345678",
    "login.phoneHint": "Enter with country code, e.g. +66 for Thailand",
    "login.phoneSendOtp": "📱 Send OTP Code",
    "login.phoneInvalid": "Please enter a valid phone number with country code",
    "login.otpSent": "OTP sent!",
    "login.otpDesc": "Enter the 6-digit code sent to",
    "login.otpInvalid": "Please enter a 6-digit code",
    "login.phoneVerify": "✅ Verify & Sign In",
  ...
  th: {
    ...
    "login.or": "หรือเข้าสู่ระบบด้วย",
    "login.tabEmail": "อีเมล",
    "login.tabPhone": "เบอร์โทร",
    "login.emailPlaceholder": "you@example.com",
    "login.emailSubmit": "✉️ ส่ง Magic Link",
    "login.emailSent": "ส่ง Magic Link แล้ว!",
    "login.emailSentDesc": "เช็คอีเมลของคุณ — คลิกลิงก์ที่เราส่งไปเพื่อเข้าสู่ระบบ ปิดหน้านี้ได้เลย",
    "login.phonePlaceholder": "+66 812345678",
    "login.phoneHint": "ใส่รหัสประเทศ เช่น +66 สำหรับประเทศไทย",
    "login.phoneSendOtp": "📱 ส่งรหัส OTP",
    "login.phoneInvalid": "กรุณาใส่เบอร์โทรพร้อมรหัสประเทศ",
    "login.otpSent": "ส่ง OTP แล้ว!",
    "login.otpDesc": "กรอกรหัส 6 หลักที่ส่งไปยัง",
    "login.otpInvalid": "กรุณากรอกรหัส 6 หลัก",
    "login.phoneVerify": "✅ ยืนยันและเข้าสู่ระบบ",
    "login.phoneChangeNumber": "← เปลี่ยนเบอร์",
